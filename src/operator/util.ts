const {GenerateUuidOperation, ReadOperation, GenerateTmpstmpOperation ,EqualOperation, AndOrOperation, equalReturn,stringifybase64} = require("./operations")
import {Input} from "./schema"

function evaluateOperation(context : any, op : any) {
...
function __evaluateInput(context : any, inputObj : any,type : any) {
